...
CC_580AI_PROVIDER_MODEL_CONFIG = provider_model_config("580AI")
...
CC_580AI_MODELS = ["gpt-5.4-mini"]


@register_llm
class CC580AILLMConfiguration(BaseLLMConfiguration):
    model_config = CC_580AI_PROVIDER_MODEL_CONFIG
    provider: Literal[ServiceProviders.CC_580AI] = ServiceProviders.CC_580AI
    model: str = Field(
        default="gpt-5.4-mini",
        description="580AI chat model.",
        json_schema_extra={"examples": CC_580AI_MODELS, "allow_custom_input": True},
    )
    base_url: str = Field(
        default="https://cc.580ai.net/v1",
        description="580AI compatible API endpoint.",
    )
